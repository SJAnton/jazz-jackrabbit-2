...
uint8_t ServerProtocol::encodeTipoRecolectable(TipoRecolectable tipo){
    switch (tipo)
    {
    case TipoRecolectable::Diamante : return ITEM_DIAMANTE;
    case TipoRecolectable::Moneda : return ITEM_MONEDA;
    case TipoRecolectable::Zanahoria : return ITEM_ZANAHORIA;
    case TipoRecolectable::Municion : return ITEM_MUNCION;
